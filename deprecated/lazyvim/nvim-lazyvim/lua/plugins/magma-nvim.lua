...
return {
  {
    ...
    keys = {
      ...
      { "<leader>ml", "<cmd>MagmaEvaluateLine<CR>", desc = "Evaluate the current line.", mode = { "n", "v" } },
      { "<leader>mv", "<cmd>MagmaEvaluateVisual<CR>", desc = "Evaluate the selected text.", mode = { "n", "v" } },
      -- { "<leader>mc", "<cmd>MagmaEvaluateOperator<CR>", desc = "Reevaluate the currently selected cell.", mode = {'n', 'v'}  },
